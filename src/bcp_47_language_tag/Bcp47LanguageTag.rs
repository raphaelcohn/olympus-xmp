...
impl Bcp47LanguageTag
{
	...
	#[inline(always)]
	fn parse_from_language(mut subtags: Subtags) -> Result<Self, Bcp47LanguageTagParseError>
	{
	...
	#[inline(always)]
	fn parse_from_script<'a>(subtag: &'a [u8], subtags: Subtags<'a>, language: Language) -> Result<Self, Bcp47LanguageTagParseError>
	{
	...
	#[inline(always)]
	fn parse_from_region_2<'a>(subtag: &'a [u8], subtags: Subtags<'a>, language: Language, script: Option<IanaRegisteredIso15924ScriptCode>) -> Result<Self, Bcp47LanguageTagParseError>
	{
	...
	#[inline(always)]
	fn parse_from_region_3<'a>(subtag: &'a [u8], subtags: Subtags<'a>, language: Language, script: Option<IanaRegisteredIso15924ScriptCode>) -> Result<Self, Bcp47LanguageTagParseError>
	{
	...
	#[inline(always)]
	fn parse_from_region(mut subtags: Subtags, language: Language, script: Option<IanaRegisteredIso15924ScriptCode>) -> Result<Self, Bcp47LanguageTagParseError>
	{
	...
	#[inline(always)]
	fn parse_from_variant(mut subtags: Subtags, language: Language, script: Option<IanaRegisteredIso15924ScriptCode>, region: Option<IanaRegisteredRegionCode>) -> Result<Self, Bcp47LanguageTagParseError>
	{
	...
	#[inline(always)]
	fn parse_from_variant_irregular_grandfathered_second_region(subtags: Subtags, subtag: &[u8], language: Language, region: Option<IanaRegisteredRegionCode>) -> Result<Bcp47LanguageTag, Bcp47LanguageTagParseError>
	{
	...
	#[inline(always)]
	fn parse_from_variant_irregular_grandfathered_oed(subtags: Subtags, subtag: &[u8], language: Language, region: Option<IanaRegisteredRegionCode>) -> Result<Bcp47LanguageTag, Bcp47LanguageTagParseError>
	{
	...
	#[inline(always)]
	fn parse_from_variant_4_first_digit<'a>(subtag: &'a [u8], subtags: Subtags<'a>, language: Language, script: Option<IanaRegisteredIso15924ScriptCode>, region: Option<IanaRegisteredRegionCode>, first_digit: Digit) -> Result<Self, Bcp47LanguageTagParseError>
	{
	...
	#[inline(always)]
	fn parse_from_variant_5<'a>(subtag: &'a [u8], subtags: Subtags<'a>, language: Language, script: Option<IanaRegisteredIso15924ScriptCode>, region: Option<IanaRegisteredRegionCode>) -> Result<Self, Bcp47LanguageTagParseError>
	{
	...
	#[inline(always)]
	fn parse_from_variant_6<'a>(subtag: &'a [u8], subtags: Subtags<'a>, language: Language, script: Option<IanaRegisteredIso15924ScriptCode>, region: Option<IanaRegisteredRegionCode>) -> Result<Self, Bcp47LanguageTagParseError>
	{
	...
	#[inline(always)]
	fn parse_from_variant_7<'a>(subtag: &'a [u8], subtags: Subtags<'a>, language: Language, script: Option<IanaRegisteredIso15924ScriptCode>, region: Option<IanaRegisteredRegionCode>) -> Result<Self, Bcp47LanguageTagParseError>
	{
	...
	#[inline(always)]
	fn parse_from_variant_8<'a>(subtag: &'a [u8], subtags: Subtags<'a>, language: Language, script: Option<IanaRegisteredIso15924ScriptCode>, region: Option<IanaRegisteredRegionCode>) -> Result<Self, Bcp47LanguageTagParseError>
	{
	...
	#[inline(always)]
	fn parse_remaining_variants(mut variants: HashSet<Variant>, mut subtags: Subtags, language: Language, script: Option<IanaRegisteredIso15924ScriptCode>, region: Option<IanaRegisteredRegionCode>) -> Result<Self, Bcp47LanguageTagParseError>
	{
		loop
		{
	...
	#[inline(always)]
	fn parse_from_extension(validated_extension_code: u8, mut subtags: Subtags, language: Language, script: Option<IanaRegisteredIso15924ScriptCode>, region: Option<IanaRegisteredRegionCode>, variants: HashSet<Variant>) -> Result<Bcp47LanguageTag, Bcp47LanguageTagParseError>
	{
	...
	#[inline(always)]
	fn parse_from_private_use(subtags: Subtags, language: Language, script: Option<IanaRegisteredIso15924ScriptCode>, region: Option<IanaRegisteredRegionCode>, variants: HashSet<Variant>, extensions: HashMap<Singleton, Extension>) -> Result<Self, Bcp47LanguageTagParseError>
	{
		Self::from_private_use_ok(language, script, region, variants, extensions, Some(PrivateUse::parse(subtags)?))
	}
	
	#[inline(always)]
	fn parse_x_or_i_subtag<'a>(subtag: &'a [u8], subtags: Subtags<'a>) -> Result<Self, Bcp47LanguageTagParseError>
	{
