...
pub(super) const Revision4EnglishCustomsAreas: [(M49Code, &'static str, &'static [M49Code]); 7] =
[
	...
	revision_3_or_4_customs_areas(b"579", "Norway including Svalbard and Jan Mayen Islands", constituents![b"578", b"744"]),
	revision_3_or_4_customs_areas(b"757", "Switzerland-Liechtenstein", constituents![b"756", b"438"]),
	revision_3_or_4_customs_areas(b"841", "United States including Puerto Rico", constituents![b"840", b"630"]),
	revision_3_or_4_customs_areas(b"842", "United States including Puerto Rico and United States Virgin Islands", constituents![b"840", b"630", b"850"]),
];
