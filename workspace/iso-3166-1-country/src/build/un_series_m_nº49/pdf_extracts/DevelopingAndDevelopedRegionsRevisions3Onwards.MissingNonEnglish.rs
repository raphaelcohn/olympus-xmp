...
(
	(
		M49Code,
		&'static str,
		[(M49Code, &'static str); 4],
	),
	(
		M49Code,
		&'static str,
		[(M49Code, &'static str, &'static str, Option<M49Code>); 7]
	),
) =
{
	#[inline(always)]
	const fn developed_region(m49_code: &'static [u8; 3], english_name_revision_3_and_4: &'static str) -> (M49Code, &'static str)
	{
		(M49Code::from(m49_code), english_name_revision_3_and_4)
	}
	
	#[inline(always)]
	const fn developing_region(m49_code: &'static [u8; 3], english_name_revision_3: &'static str, english_name_revision_4: &'static str, excludes: Option<&'static [u8; 3]>) -> (M49Code, &'static str, &'static str, Option<M49Code>)
	{
		#[inline(always)]
		const fn map(m49_code: &'static [u8; 3]) -> M49Code
		{
			M49Code::from(m49_code)
		}
		
		(M49Code::from(m49_code), english_name_revision_3, english_name_revision_3, excludes.map(map))
	}
