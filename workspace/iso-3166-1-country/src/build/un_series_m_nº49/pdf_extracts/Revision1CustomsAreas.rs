...
pub(super) const Revision1CustomsAreas: [(M49Code, &'static str, &'static [M49Code]); 7] =
[
	...
	//custom_area(b"724", "Spain", constituents![b"724", b"728"]), // This seems to be a mistake in Revision 1, as Spanish North Africa no longer existed in 1975 and was not defined in Revision 1.
