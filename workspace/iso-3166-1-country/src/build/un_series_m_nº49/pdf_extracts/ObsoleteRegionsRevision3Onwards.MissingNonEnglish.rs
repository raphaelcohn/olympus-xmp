...
pub(super) const ObsoleteRegionsRevision3Onwards: [(M49Code, &'static str, &'static [M49Code]); 14] =
{
	#[inline(always)]
	const fn obsolete_region_revision_3_onwards(old_m49_code: &[u8; 3], english_name: &'static str, replacements: &'static [M49Code]) -> (M49Code, &'static str, &'static [M49Code])
	{
