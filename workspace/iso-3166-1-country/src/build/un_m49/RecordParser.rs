...
#[derive(Debug, Clone)]
struct RecordParser(CrudeCsvLineIterator<'static>);
...
{
	#[inline(always)]
	fn parse_record(mut self, english_csv_file_contains_country_names_with_commas: bool) -> Record
	{
