...
pub(crate) struct UninitialisedArray<RB: RestrictedByte, const length: usize>([MaybeUninit<RB>; length]);
...
{
	#[inline(always)]
	pub(crate) fn convert(&mut self, byte: u8, index: usize)
	{
	...
	#[inline(always)]
	pub(crate) fn initialise(self) -> [RB; length]
	{
