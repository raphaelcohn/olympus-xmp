...
impl const Default for ExifResolutionUnit
{
	#[inline(always)]
	fn default() -> Self
	{
		ExifResolutionUnit::Inches
	}
}

impl<'a> XmpAttributeValue<'a> for ExifResolutionUnit
{
	...
	{
		XmpAttributeValueParseError::ExifResolutionUnit(error)
	}
}
