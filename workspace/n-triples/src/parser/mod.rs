...
use super::internationalized_resource_identifier::AbsoluteInternationalizedResourceIdentifierStringParseError;
...
use swiss_army_knife::a_to_z::OpenBrace;
use swiss_army_knife::a_to_z::Pipe;
...
include!("AbsoluteInternationalizedResourceIdentifierNTripleParser.rs");
...
include!("Utf8SequenceParserUchar.rs");
