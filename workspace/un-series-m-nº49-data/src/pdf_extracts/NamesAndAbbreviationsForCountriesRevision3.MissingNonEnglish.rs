...
pub(super) const NamesAndAbbreviationsForCountriesRevision3: [(M49Code, StaticEnglishName, Option<Revision3Or4Abbreviations>, Option<Iso3166Dash1Alpha3Code>); 233] =
{
	#[inline(always)]
	const fn names_and_abbreviations_for_country_revision_3(m49_code: StaticM49Code, english_name: StaticEnglishName, english_twelve_character_abbreviation: Option<StaticAbbreviation>, iso_3166_alpha_3_code: Option<StaticIso3166Dash1Alpha3Code>) -> (M49Code, StaticEnglishName, Option<Revision3Or4Abbreviations>, Option<Iso3166Dash1Alpha3Code>)
	{
		(
			M49Code::from(m49_code),
			english_name,
			english_twelve_character_abbreviation.map(const_revision_3_or_4_abbreviations),
			iso_3166_alpha_3_code.map(const_iso_3166_dash_1_alpha_3_code_from)
		)
	}
