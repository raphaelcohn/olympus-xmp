...
pub(super) const NamesAndAbbreviationsForRegionsAndGroupingsRevision2: [(M49Code, StaticEnglishName, (EightCharacterAbbreviation, TwelveCharacterAbbreviation)); 37] =
{
	#[inline(always)]
	const fn names_and_abbreviations_for_region_and_grouping_revision_2(m49_code: StaticM49Code, english_name: StaticEnglishName, legacy_english_eight_character_abbreviation: StaticAbbreviation, english_twelve_character_abbreviation: StaticAbbreviation) -> (M49Code, StaticEnglishName, (EightCharacterAbbreviation, TwelveCharacterAbbreviation))
	{
		(M49Code::from(m49_code), english_name, (EightCharacterAbbreviation::new(legacy_english_eight_character_abbreviation), TwelveCharacterAbbreviation::new(english_twelve_character_abbreviation)))
	}
