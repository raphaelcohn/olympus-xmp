...
pub(super) const OtherGroupingsRevision2: [(M49Code, StaticEnglishName); 7] =
{
	#[inline(always)]
	const fn other_grouping_revision_2(m49_code: StaticM49Code, english_name: StaticEnglishName) -> (M49Code, StaticEnglishName)
	{
