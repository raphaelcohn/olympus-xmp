...
pub(super) const RegionOrOtherGroupingNotElsewhereSpecifiedRevision3Onwards: [(M49Code, StaticEnglishName); 14] =
{
	#[inline(always)]
	const fn region_or_other_grouping_not_elsewhere_specified_revision_3_onwards(m49_code: StaticM49Code, english_name: StaticEnglishName) -> (M49Code, StaticEnglishName)
	{
